<%-- 
    ...
    Created on : 2 Oct, 2024, 5:23:42 PM
    Author     : ydhup
--%>
...
<html>
    ...
    <body>
        <div id="main_card">
            <form action="FacultyCheckerServlet" method="post">
                <table height="300" width="450">
                    <tr>
                        <td><strong>Enter Your Id : </strong></td>
                        <td><strong><input type="text" name="facultyId" placeholder="Enter ID"></strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><strong><input type="hidden" name="role" value="Faculty"></strong></td>
                    </tr>
                </table>
                <br>
