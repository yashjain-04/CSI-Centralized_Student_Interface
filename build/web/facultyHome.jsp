<%-- 
    ...
    Created on : 11 Oct, 2024, 7:18:25 PM
    Author     : ydhup
--%>
...
<html>
    ...
    <%
        ...
        if(session.getAttribute("username") == null){
            ...
            String facultyID = (String)session.getAttribute("username");
    ...
    <body>
        ...
        <div class="sections">
            ...
            <div class="card">
                ...
                <hr>
                <div id="innercard">
                    <a href="facultyNotification.jsp"><i class="fa-regular fa-bell"></i></a>
                </div>
            ...
            <div class="card">
                ...
                <hr>
                <div id="innercard">
                    <a href="facultyHomeComplaint.jsp"><i class="fa-regular fa-comment-dots"></i></a>
                </div>
